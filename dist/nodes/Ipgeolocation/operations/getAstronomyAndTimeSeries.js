...
exports.getAstronomyAndTimeSeries = void 0;
exports.getAstronomyAndTimeSeries = [
    {
    ...
    },
    {
        ...
        description: 'End date in YYYY-MM-DD format. Must be greater than the Start Date and must not exceed 90 days after it.',
        routing: {
            request: {
                qs: {
...
//# sourceMappingURL=getAstronomyAndTimeSeries.js.map